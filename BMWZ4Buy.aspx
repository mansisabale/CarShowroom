<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="BMWZ4Buy.aspx.cs" Inherits="CarWebsite.BMWZ4Buy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div id="topCarImaage">
         <div id="carImageRed" class=" img">
             <img src="BMWZ4/BMWZ4RED.jpg" />
         </div>
         <div id="carImageBlue" class="img">
             <img src="BMWZ4/BMWZ4BLUE.jpg" />
         </div>
         <div id="carImageWhite" class="img">
             <img src="BMWZ4/BMWZ4WHITE.jpg" />
         </div>
         <div id="carImageBlack" class="img">
             <img src="BMWZ4/BMWZ4BLACK.jpg" />
         </div>
     </div> 
