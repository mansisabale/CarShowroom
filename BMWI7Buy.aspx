<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="BMWI7Buy.aspx.cs" Inherits="CarWebsite.BMWI7Buy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="topCarImaage">
        <div id="carImageWhite" class=" img">
            <img src="bmwi7/bmwi7whiteside.jpg" />
            <img src="bmwi7/bmwi7whiteside1.png" />
            <img src="bmwi7/bmwi7side1.png"/>
        </div>
        <div id="carImageBlue" class="img">
            <img src="bmwi7/bmwi7blue.png" />
            
        </div>
        <div id="carImageRed" class="img">
            <img src="bmwi7/bmwi7red.jpg" />
            
        </div>
        <div id="carImageBlack" class="img">
            <img src="bmwi7/bmwi7blackfront.jpg" />
            <img src="bmwi7/bmwi7blackside.jpg" />
