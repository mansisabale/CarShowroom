<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="BMWX3Buy.aspx.cs" Inherits="CarWebsite.BMWX3Buy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="topCarImaage">
        <div id="carImageRed" class=" img">
            <img src="BMWX3/bmwx3red.jpg" />
        </div>
        <div id="carImageBlue" class="img">
            <img src="BMWX3/bmwx3blue.jpg" />
        </div>
        <div id="carImageWhite" class="img">
            <img src="BMWX3/bmwx3white.jpg" />
        </div>
        <div id="carImageBlack" class="img">
            <img src="BMWX3/bmwx3black.jpg" />
        </div>
    </div> 
