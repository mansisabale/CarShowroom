<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="BMWM4Buy.aspx.cs" Inherits="CarWebsite.BMWM4Buy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="topCarImaage">
        <div id="carImageRed" class=" img">
            <img src="bmwm4/bmwm4red.jpg" />
        </div>
        <div id="carImageBlue" class="img">
            <img src="bmwm4/bmwm4blue.jpeg" />
        </div>
        <div id="carImageWhite" class="img">
            <img src="bmwm4/bmwm4white.jpg" />
        </div>
        <div id="carImageBlack" class="img">
            <img src="bmwm4/bmwm4black.jpg" />
        </div>
    </div> 
