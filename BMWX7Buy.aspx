<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="BMWX7Buy.aspx.cs" Inherits="CarWebsite.BMWX7Buy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div id="topCarImaage">
         <div id="carImageRed" class=" img">
             <img src="BMWX7/BMWX7RED.jpg" />
         </div>
         <div id="carImageBlue" class="img">
             <img src="BMWX7/BMWXYBLUE.jpg" />
         </div>
         <div id="carImageWhite" class="img">
             <img src="BMWX7/BMWX7WHITE.jpg" />
         </div>
         <div id="carImageBlack" class="img">
             <img src="BMWX7/BMWX7BLACK.jpg" />
         </div>
     </div> 
