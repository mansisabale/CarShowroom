<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="BMWX5Buy.aspx.cs" Inherits="CarWebsite.BMWX5Buy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="topCarImaage">
        <div id="carImageRed" class=" img">
            <img src="bmwx5/BMWX5Buy.jpg" />
        </div>
        <div id="carImageBlue" class="img">
            <img src="bmwx5/BMWX5BLUE.jpg" />
        </div>
        <div id="carImageWhite" class="img">
            <img src="bmwx5/BMWX5WHITE.png"/>
        </div>
        <div id="carImageBlack" class="img">
            <img src="bmwx5/BMWX5BLACK.jpg" />
        </div>
    </div> 
