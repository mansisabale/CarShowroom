<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="BMWM8Buy.aspx.cs" Inherits="CarWebsite.BMWM8Buy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="topCarImaage">
        <div id="carImageRed" class=" img">
            <img src="bmwm8/bmwm8red.jpg" />
        </div>
        <div id="carImageBlue" class="img">
            <img src="bmwm8/bmwm8blue.jpg" />
        </div>
        <div id="carImageWhite" class="img">
            <img src="bmwm8/bmwm8white.jpg" />
        </div>
        <div id="carImageBlack" class="img">
            <img src="bmwm8/bmwm8black.jpg" />
        </div>
    </div> 
