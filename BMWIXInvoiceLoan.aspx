<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="BMWIXInvoiceLoan.aspx.cs" Inherits="CarWebsite.BMWIXInvoiceLoan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <asp:TableRow>
    ...
    <asp:TableCell CssClass="cell">
        <asp:Label ID="emiFinance" Font-Bold="true" runat="server" Text=""></asp:Label>
    </asp:TableCell>
    <asp:TableCell CssClass="cell">
        Emi Period
    </asp:TableCell>
    ...
    <asp:TableCell CssClass="cell">
        <asp:Label ID="emiPeriod" Font-Bold="true" runat="server" Text=""></asp:Label>Years
    </asp:TableCell>
    <asp:TableCell CssClass="cell">
        Rate Of Interes
    </asp:TableCell>
    ...
    <asp:TableCell CssClass="cell">
        <asp:Label ID="emiROI" Font-Bold="true" runat="server" Text=""></asp:Label>%
    </asp:TableCell>
</asp:TableRow>
            <asp:TableRow>
                <asp:TableCell CssClass="cell">
...
<asp:TableCell CssClass="cell">
    <asp:Label ID="emiPrice" Font-Bold="true" runat="server" Text=""></asp:Label>
</asp:TableCell>
            </asp:TableRow>
        <asp:TableHeaderRow>
            <asp:TableHeaderCell>
    ...
    <div style="text-align:center;width:100%">
        <asp:Button ID="Button1" CssClass="btn" runat="server" Text="Pay" OnClick="Button1_Click" />
    </div>
</div>
</asp:Content>
