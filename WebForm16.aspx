<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="WebForm16.aspx.cs" Inherits="CarWebsite.WebForm16" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
 ...
 <div  style="margin-left:100px;margin-right:100px;margin-top:100px">
     ...
     <div style="display:flex">
         <div>
             <asp:Image ID="Image9" runat="server" ImageUrl="~/caricons/bmw-ix.png" />
         </div>
         <div >
