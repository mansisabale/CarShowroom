<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="EmpDetails.aspx.cs" Inherits="CarWebsite.EmpDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div style="margin-left:70px">
      <h1>All User Details</h1>
         <asp:SqlDataSource runat="server" ConnectionString="<%$ ConnectionStrings:automobileshopConnectionString %>" SelectCommand="SELECT id, name, phoneno, email, pass, acctype FROM userinfo WHERE (acctype = 'emp')" ID="SqlDataSource1"></asp:SqlDataSource>
         <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Height="189px" Width="795px" DataSourceID="SqlDataSource1" DataKeyNames="id">
          <Columns>
     ...
     <br />
     <br />
     <asp:Button ID="Button4" runat="server" style="margin-right:20px" CssClass="buybtn" Text="Refresh" OnClick="Refresh" CausesValidation="false"/>
     <asp:Button ID="Button3" CssClass="buybtn" runat="server" Text="Add Employee" OnClick="Button3_Click" />
         ...
         <asp:View ID="View3" runat="server">
             <table>
                 ...
                 <tr>
                     ...
                     <td></td>
                     <td>
                         <asp:Button ID="Button2" CssClass="buybtn" runat="server" OnClick="Add_User" Text="Add Employee" />
                     </td>
                 </tr>
                 <tr>
                     <td></td>
